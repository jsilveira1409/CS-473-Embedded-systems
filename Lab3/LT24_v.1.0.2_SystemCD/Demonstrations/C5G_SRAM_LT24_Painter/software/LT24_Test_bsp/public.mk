...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../C5G_LT24_Painter_SRAM.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x101080
SOPC_SYSID_FLAG += --sidp=0x101080
ELF_PATCH_FLAG  += --sidp 0x101080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1403484297
SOPC_SYSID_FLAG += --timestamp=1403484297
ELF_PATCH_FLAG  += --timestamp 1403484297
