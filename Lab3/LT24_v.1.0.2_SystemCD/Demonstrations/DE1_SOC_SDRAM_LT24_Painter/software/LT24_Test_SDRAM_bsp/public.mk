...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE1_SOC_SDRAM.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001080
SOPC_SYSID_FLAG += --sidp=0x8001080
ELF_PATCH_FLAG  += --sidp 0x8001080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1403171480
SOPC_SYSID_FLAG += --timestamp=1403171480
ELF_PATCH_FLAG  += --timestamp 1403171480
