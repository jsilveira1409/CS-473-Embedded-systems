...
# Mon Nov 14 16:07:05 CET 2022
# DO NOT MODIFY


# 
# DaisyPort "DaisyPort" v1.0
#  2022.11.14.16:07:05
# 
# 
...
set_module_property NAME DaisyPort
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME DaisyPort
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL DaisyPort
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file DaisyPort.vhd VHDL PATH DaisyPort.vhd TOP_LEVEL_FILE

add_fileset SIM_VERILOG SIM_VERILOG "" ""
set_fileset_property SIM_VERILOG TOP_LEVEL DaisyPort
set_fileset_property SIM_VERILOG ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property SIM_VERILOG ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file DaisyPort.vhd VHDL PATH DaisyPort.vhd
...
add_interface_port clock_reset nReset reset_n Input 1
...
add_interface_port conduit_end LEDPort writeresponsevalid_n Output 1
...
add_interface_port clock_sink clk_enable clk Input 1
