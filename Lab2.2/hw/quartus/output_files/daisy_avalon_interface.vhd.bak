...
ENTITY reg32_avalon_interface IS
	PORT ( 	clock, resetn : IN STD_LOGIC;
				...
				Q_export : OUT STD_LOGIC_VECTOR(23 DOWNTO 0) );
...
ARCHITECTURE Structure OF reg32_avalon_interface IS
	...
	BEGIN
		...
		WITH (chipselect AND write) SELECT
			local_byteenable <= byteenable WHEN '1', "000" WHEN OTHERS;
		reg_instance: outreg24 PORT MAP (clock, resetn, to_reg, local_byteenable, from_reg);
		readdata <= from_reg;
		Q_export <= from_reg;
END Structure;