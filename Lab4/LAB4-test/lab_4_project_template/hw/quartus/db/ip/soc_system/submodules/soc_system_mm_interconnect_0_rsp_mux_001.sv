...
//   PIPELINE_ARB:        0
//   PKT_TRANS_LOCK:      75 (arbitration locking enabled)
//   ST_DATA_W:           117
//   ST_CHANNEL_W:        6
// ------------------------------------------
...
(
    ...
    always @* begin
      lock[0] = sink0_data[75];
      lock[1] = sink1_data[75];
      lock[2] = sink2_data[75];
      lock[3] = sink3_data[75];
      lock[4] = sink4_data[75];
      lock[5] = sink5_data[75];
    end
