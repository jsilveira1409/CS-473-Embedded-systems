...
add_interface_port as AS_Address address Input 9
...
set_interface_property csx associatedReset areset_sink
...
add_interface_port csx CSX id1 Output 1
...
add_interface_port wrx WRX id5 Output 1
...
add_interface_port resx RESX id4 Output 1
...
add_interface_port dcx DCX id3 Output 1
...
# connection point dd
# 
add_interface dd conduit end
set_interface_property dd associatedClock clock
set_interface_property dd associatedReset ""
set_interface_property dd ENABLED true
set_interface_property dd EXPORT_OF ""
set_interface_property dd PORT_NAME_MAP ""
set_interface_property dd CMSIS_SVD_VARIABLES ""
set_interface_property dd SVD_ADDRESS_GROUP ""

add_interface_port dd D id2 Output 16
