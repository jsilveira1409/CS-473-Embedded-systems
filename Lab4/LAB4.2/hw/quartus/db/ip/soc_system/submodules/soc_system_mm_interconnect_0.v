...
module soc_system_mm_interconnect_0 (
		...
		input  wire        lcd_0_areset_sink_reset_bridge_in_reset_reset,        //  lcd_0_areset_sink_reset_bridge_in_reset.reset
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset,       // nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire [31:0] lcd_0_AM_address,                                     //                                 lcd_0_AM.address
		output wire        lcd_0_AM_waitrequest,                                 //                                         .waitrequest
		input  wire        lcd_0_AM_read,                                        //                                         .read
		output wire [15:0] lcd_0_AM_readdata,                                    //                                         .readdata
		output wire        lcd_0_AM_readdatavalid,                               //                                         .readdatavalid
		...
		output wire [15:0] lcd_0_as_address,                                     //                                 lcd_0_as.address
		output wire        lcd_0_as_write,                                       //                                         .write
		output wire        lcd_0_as_read,                                        //                                         .read
		input  wire [15:0] lcd_0_as_readdata,                                    //                                         .readdata
		output wire [15:0] lcd_0_as_writedata,                                   //                                         .writedata
	...
	wire          lcd_0_am_translator_avalon_universal_master_0_waitrequest;                              // lcd_0_AM_agent:av_waitrequest -> lcd_0_AM_translator:uav_waitrequest
	wire   [15:0] lcd_0_am_translator_avalon_universal_master_0_readdata;                                 // lcd_0_AM_agent:av_readdata -> lcd_0_AM_translator:uav_readdata
	wire          lcd_0_am_translator_avalon_universal_master_0_debugaccess;                              // lcd_0_AM_translator:uav_debugaccess -> lcd_0_AM_agent:av_debugaccess
	wire   [31:0] lcd_0_am_translator_avalon_universal_master_0_address;                                  // lcd_0_AM_translator:uav_address -> lcd_0_AM_agent:av_address
	wire          lcd_0_am_translator_avalon_universal_master_0_read;                                     // lcd_0_AM_translator:uav_read -> lcd_0_AM_agent:av_read
	wire    [1:0] lcd_0_am_translator_avalon_universal_master_0_byteenable;                               // lcd_0_AM_translator:uav_byteenable -> lcd_0_AM_agent:av_byteenable
	wire          lcd_0_am_translator_avalon_universal_master_0_readdatavalid;                            // lcd_0_AM_agent:av_readdatavalid -> lcd_0_AM_translator:uav_readdatavalid
	wire          lcd_0_am_translator_avalon_universal_master_0_lock;                                     // lcd_0_AM_translator:uav_lock -> lcd_0_AM_agent:av_lock
	wire          lcd_0_am_translator_avalon_universal_master_0_write;                                    // lcd_0_AM_translator:uav_write -> lcd_0_AM_agent:av_write
	wire   [15:0] lcd_0_am_translator_avalon_universal_master_0_writedata;                                // lcd_0_AM_translator:uav_writedata -> lcd_0_AM_agent:av_writedata
	wire    [1:0] lcd_0_am_translator_avalon_universal_master_0_burstcount;                               // lcd_0_AM_translator:uav_burstcount -> lcd_0_AM_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                      // rsp_mux:src_valid -> lcd_0_AM_agent:rp_valid
	wire   [95:0] rsp_mux_src_data;                                                                       // rsp_mux:src_data -> lcd_0_AM_agent:rp_data
	wire          rsp_mux_src_ready;                                                                      // lcd_0_AM_agent:rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                                    // rsp_mux:src_channel -> lcd_0_AM_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                              // rsp_mux:src_startofpacket -> lcd_0_AM_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                // rsp_mux:src_endofpacket -> lcd_0_AM_agent:rp_endofpacket
	...
	wire   [15:0] lcd_0_as_agent_m0_readdata;                                                             // lcd_0_as_translator:uav_readdata -> lcd_0_as_agent:m0_readdata
	wire          lcd_0_as_agent_m0_waitrequest;                                                          // lcd_0_as_translator:uav_waitrequest -> lcd_0_as_agent:m0_waitrequest
	wire          lcd_0_as_agent_m0_debugaccess;                                                          // lcd_0_as_agent:m0_debugaccess -> lcd_0_as_translator:uav_debugaccess
	wire   [31:0] lcd_0_as_agent_m0_address;                                                              // lcd_0_as_agent:m0_address -> lcd_0_as_translator:uav_address
	wire    [1:0] lcd_0_as_agent_m0_byteenable;                                                           // lcd_0_as_agent:m0_byteenable -> lcd_0_as_translator:uav_byteenable
	wire          lcd_0_as_agent_m0_read;                                                                 // lcd_0_as_agent:m0_read -> lcd_0_as_translator:uav_read
	wire          lcd_0_as_agent_m0_readdatavalid;                                                        // lcd_0_as_translator:uav_readdatavalid -> lcd_0_as_agent:m0_readdatavalid
	wire          lcd_0_as_agent_m0_lock;                                                                 // lcd_0_as_agent:m0_lock -> lcd_0_as_translator:uav_lock
	wire   [15:0] lcd_0_as_agent_m0_writedata;                                                            // lcd_0_as_agent:m0_writedata -> lcd_0_as_translator:uav_writedata
	wire          lcd_0_as_agent_m0_write;                                                                // lcd_0_as_agent:m0_write -> lcd_0_as_translator:uav_write
	wire    [1:0] lcd_0_as_agent_m0_burstcount;                                                           // lcd_0_as_agent:m0_burstcount -> lcd_0_as_translator:uav_burstcount
	wire          lcd_0_as_agent_rf_source_valid;                                                         // lcd_0_as_agent:rf_source_valid -> lcd_0_as_agent_rsp_fifo:in_valid
	wire   [96:0] lcd_0_as_agent_rf_source_data;                                                          // lcd_0_as_agent:rf_source_data -> lcd_0_as_agent_rsp_fifo:in_data
	wire          lcd_0_as_agent_rf_source_ready;                                                         // lcd_0_as_agent_rsp_fifo:in_ready -> lcd_0_as_agent:rf_source_ready
	wire          lcd_0_as_agent_rf_source_startofpacket;                                                 // lcd_0_as_agent:rf_source_startofpacket -> lcd_0_as_agent_rsp_fifo:in_startofpacket
	wire          lcd_0_as_agent_rf_source_endofpacket;                                                   // lcd_0_as_agent:rf_source_endofpacket -> lcd_0_as_agent_rsp_fifo:in_endofpacket
	wire          lcd_0_as_agent_rsp_fifo_out_valid;                                                      // lcd_0_as_agent_rsp_fifo:out_valid -> lcd_0_as_agent:rf_sink_valid
	wire   [96:0] lcd_0_as_agent_rsp_fifo_out_data;                                                       // lcd_0_as_agent_rsp_fifo:out_data -> lcd_0_as_agent:rf_sink_data
	wire          lcd_0_as_agent_rsp_fifo_out_ready;                                                      // lcd_0_as_agent:rf_sink_ready -> lcd_0_as_agent_rsp_fifo:out_ready
	wire          lcd_0_as_agent_rsp_fifo_out_startofpacket;                                              // lcd_0_as_agent_rsp_fifo:out_startofpacket -> lcd_0_as_agent:rf_sink_startofpacket
	wire          lcd_0_as_agent_rsp_fifo_out_endofpacket;                                                // lcd_0_as_agent_rsp_fifo:out_endofpacket -> lcd_0_as_agent:rf_sink_endofpacket
	...
	wire  [113:0] cmd_mux_002_src_data;                                                                   // cmd_mux_002:src_data -> jtag_uart_0_avalon_jtag_slave_agent:cp_data
	...
	wire          lcd_0_am_agent_cp_valid;                                                                // lcd_0_AM_agent:cp_valid -> router:sink_valid
	wire   [95:0] lcd_0_am_agent_cp_data;                                                                 // lcd_0_AM_agent:cp_data -> router:sink_data
	wire          lcd_0_am_agent_cp_ready;                                                                // router:sink_ready -> lcd_0_AM_agent:cp_ready
	wire          lcd_0_am_agent_cp_startofpacket;                                                        // lcd_0_AM_agent:cp_startofpacket -> router:sink_startofpacket
	wire          lcd_0_am_agent_cp_endofpacket;                                                          // lcd_0_AM_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          lcd_0_as_agent_rp_valid;                                                                // lcd_0_as_agent:rp_valid -> router_004:sink_valid
	wire   [95:0] lcd_0_as_agent_rp_data;                                                                 // lcd_0_as_agent:rp_data -> router_004:sink_data
	wire          lcd_0_as_agent_rp_ready;                                                                // router_004:sink_ready -> lcd_0_as_agent:rp_ready
	wire          lcd_0_as_agent_rp_startofpacket;                                                        // lcd_0_as_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          lcd_0_as_agent_rp_endofpacket;                                                          // lcd_0_as_agent:rp_endofpacket -> router_004:sink_endofpacket
	wire          router_004_src_valid;                                                                   // router_004:src_valid -> rsp_demux_001:sink_valid
	wire   [95:0] router_004_src_data;                                                                    // router_004:src_data -> rsp_demux_001:sink_data
	...
	wire          cmd_mux_001_src_valid;                                                                  // cmd_mux_001:src_valid -> lcd_0_as_burst_adapter:sink0_valid
	wire   [95:0] cmd_mux_001_src_data;                                                                   // cmd_mux_001:src_data -> lcd_0_as_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                                  // lcd_0_as_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                                // cmd_mux_001:src_channel -> lcd_0_as_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                                          // cmd_mux_001:src_startofpacket -> lcd_0_as_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                            // cmd_mux_001:src_endofpacket -> lcd_0_as_burst_adapter:sink0_endofpacket
	wire          lcd_0_as_burst_adapter_source0_valid;                                                   // lcd_0_as_burst_adapter:source0_valid -> lcd_0_as_agent:cp_valid
	wire   [95:0] lcd_0_as_burst_adapter_source0_data;                                                    // lcd_0_as_burst_adapter:source0_data -> lcd_0_as_agent:cp_data
	wire          lcd_0_as_burst_adapter_source0_ready;                                                   // lcd_0_as_agent:cp_ready -> lcd_0_as_burst_adapter:source0_ready
	wire    [5:0] lcd_0_as_burst_adapter_source0_channel;                                                 // lcd_0_as_burst_adapter:source0_channel -> lcd_0_as_agent:cp_channel
	wire          lcd_0_as_burst_adapter_source0_startofpacket;                                           // lcd_0_as_burst_adapter:source0_startofpacket -> lcd_0_as_agent:cp_startofpacket
	wire          lcd_0_as_burst_adapter_source0_endofpacket;                                             // lcd_0_as_burst_adapter:source0_endofpacket -> lcd_0_as_agent:cp_endofpacket
	...
	wire          cmd_demux_src0_valid;                                                                   // cmd_demux:src0_valid -> lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:in_valid
	wire   [95:0] cmd_demux_src0_data;                                                                    // cmd_demux:src0_data -> lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:in_data
	wire          cmd_demux_src0_ready;                                                                   // lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:in_ready -> cmd_demux:src0_ready
	wire    [5:0] cmd_demux_src0_channel;                                                                 // cmd_demux:src0_channel -> lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:in_channel
	wire          cmd_demux_src0_startofpacket;                                                           // cmd_demux:src0_startofpacket -> lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_src0_endofpacket;                                                             // cmd_demux:src0_endofpacket -> lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:in_endofpacket
	wire          lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_valid;         // lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:out_valid -> cmd_mux:sink0_valid
	wire  [113:0] lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_data;          // lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:out_data -> cmd_mux:sink0_data
	wire          lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_ready;         // cmd_mux:sink0_ready -> lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:out_ready
	wire    [5:0] lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_channel;       // lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:out_channel -> cmd_mux:sink0_channel
	wire          lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_startofpacket; // lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:out_startofpacket -> cmd_mux:sink0_startofpacket
	wire          lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_endofpacket;   // lcd_0_AM_to_address_span_extender_0_windowed_slave_cmd_width_adapter:out_endofpacket -> cmd_mux:sink0_endofpacket
	wire          cmd_demux_001_src1_valid;                                                               // cmd_demux_001:src1_valid -> nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:in_valid
	wire  [113:0] cmd_demux_001_src1_data;                                                                // cmd_demux_001:src1_data -> nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:in_data
	wire          cmd_demux_001_src1_ready;                                                               // nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:in_ready -> cmd_demux_001:src1_ready
	wire    [5:0] cmd_demux_001_src1_channel;                                                             // cmd_demux_001:src1_channel -> nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:in_channel
	wire          cmd_demux_001_src1_startofpacket;                                                       // cmd_demux_001:src1_startofpacket -> nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:in_startofpacket
	wire          cmd_demux_001_src1_endofpacket;                                                         // cmd_demux_001:src1_endofpacket -> nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:in_endofpacket
	wire          nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_valid;                       // nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:out_valid -> cmd_mux_001:sink0_valid
	wire   [95:0] nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_data;                        // nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:out_data -> cmd_mux_001:sink0_data
	wire          nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_ready;                       // cmd_mux_001:sink0_ready -> nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:out_ready
	wire    [5:0] nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_channel;                     // nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:out_channel -> cmd_mux_001:sink0_channel
	wire          nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_startofpacket;               // nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:out_startofpacket -> cmd_mux_001:sink0_startofpacket
	wire          nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_endofpacket;                 // nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter:out_endofpacket -> cmd_mux_001:sink0_endofpacket
	wire          rsp_demux_src0_valid;                                                                   // rsp_demux:src0_valid -> address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:in_valid
	wire  [113:0] rsp_demux_src0_data;                                                                    // rsp_demux:src0_data -> address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:in_data
	wire          rsp_demux_src0_ready;                                                                   // address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:in_ready -> rsp_demux:src0_ready
	wire    [5:0] rsp_demux_src0_channel;                                                                 // rsp_demux:src0_channel -> address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:in_channel
	wire          rsp_demux_src0_startofpacket;                                                           // rsp_demux:src0_startofpacket -> address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_src0_endofpacket;                                                             // rsp_demux:src0_endofpacket -> address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:in_endofpacket
	wire          address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_valid;         // address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:out_valid -> rsp_mux:sink0_valid
	wire   [95:0] address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_data;          // address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:out_data -> rsp_mux:sink0_data
	wire          address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_ready;         // rsp_mux:sink0_ready -> address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:out_ready
	wire    [5:0] address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_channel;       // address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:out_channel -> rsp_mux:sink0_channel
	wire          address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_startofpacket; // address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:out_startofpacket -> rsp_mux:sink0_startofpacket
	wire          address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_endofpacket;   // address_span_extender_0_windowed_slave_to_lcd_0_AM_rsp_width_adapter:out_endofpacket -> rsp_mux:sink0_endofpacket
	wire          rsp_demux_001_src0_valid;                                                               // rsp_demux_001:src0_valid -> lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:in_valid
	wire   [95:0] rsp_demux_001_src0_data;                                                                // rsp_demux_001:src0_data -> lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:in_data
	wire          rsp_demux_001_src0_ready;                                                               // lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:in_ready -> rsp_demux_001:src0_ready
	wire    [5:0] rsp_demux_001_src0_channel;                                                             // rsp_demux_001:src0_channel -> lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:in_channel
	wire          rsp_demux_001_src0_startofpacket;                                                       // rsp_demux_001:src0_startofpacket -> lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:in_startofpacket
	wire          rsp_demux_001_src0_endofpacket;                                                         // rsp_demux_001:src0_endofpacket -> lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:in_endofpacket
	wire          lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_valid;                       // lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:out_valid -> rsp_mux_001:sink1_valid
	wire  [113:0] lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_data;                        // lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:out_data -> rsp_mux_001:sink1_data
	wire          lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_ready;                       // rsp_mux_001:sink1_ready -> lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:out_ready
	wire    [5:0] lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_channel;                     // lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:out_channel -> rsp_mux_001:sink1_channel
	wire          lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_startofpacket;               // lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:out_startofpacket -> rsp_mux_001:sink1_startofpacket
	wire          lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_endofpacket;                 // lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter:out_endofpacket -> rsp_mux_001:sink1_endofpacket
	...
	wire          lcd_0_as_agent_rdata_fifo_src_valid;                                                    // lcd_0_as_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [17:0] lcd_0_as_agent_rdata_fifo_src_data;                                                     // lcd_0_as_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          lcd_0_as_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_001:in_0_ready -> lcd_0_as_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                      // avalon_st_adapter_001:out_0_valid -> lcd_0_as_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_001_out_0_data;                                                       // avalon_st_adapter_001:out_0_data -> lcd_0_as_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                      // lcd_0_as_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                      // avalon_st_adapter_001:out_0_error -> lcd_0_as_agent:rdata_fifo_sink_error
	...
	altera_merlin_master_translator #(
		...
		.reset                  (lcd_0_areset_sink_reset_bridge_in_reset_reset),               //                     reset.reset
		.uav_address            (lcd_0_am_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (lcd_0_am_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (lcd_0_am_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (lcd_0_am_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (lcd_0_am_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (lcd_0_am_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (lcd_0_am_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (lcd_0_am_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (lcd_0_am_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (lcd_0_am_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (lcd_0_am_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (lcd_0_AM_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (lcd_0_AM_waitrequest),                                        //                          .waitrequest
		.av_read                (lcd_0_AM_read),                                               //                          .read
		.av_readdata            (lcd_0_AM_readdata),                                           //                          .readdata
		.av_readdatavalid       (lcd_0_AM_readdatavalid),                                      //                          .readdatavalid
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (lcd_0_areset_sink_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (lcd_0_as_agent_m0_address),                     // avalon_universal_slave_0.address
		.uav_burstcount         (lcd_0_as_agent_m0_burstcount),                  //                         .burstcount
		.uav_read               (lcd_0_as_agent_m0_read),                        //                         .read
		.uav_write              (lcd_0_as_agent_m0_write),                       //                         .write
		.uav_waitrequest        (lcd_0_as_agent_m0_waitrequest),                 //                         .waitrequest
		.uav_readdatavalid      (lcd_0_as_agent_m0_readdatavalid),               //                         .readdatavalid
		.uav_byteenable         (lcd_0_as_agent_m0_byteenable),                  //                         .byteenable
		.uav_readdata           (lcd_0_as_agent_m0_readdata),                    //                         .readdata
		.uav_writedata          (lcd_0_as_agent_m0_writedata),                   //                         .writedata
		.uav_lock               (lcd_0_as_agent_m0_lock),                        //                         .lock
		.uav_debugaccess        (lcd_0_as_agent_m0_debugaccess),                 //                         .debugaccess
		.av_address             (lcd_0_as_address),                              //      avalon_anti_slave_0.address
		.av_write               (lcd_0_as_write),                                //                         .write
		.av_read                (lcd_0_as_read),                                 //                         .read
		.av_readdata            (lcd_0_as_readdata),                             //                         .readdata
		.av_writedata           (lcd_0_as_writedata),                            //                         .writedata
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.clk                   (clk_0_clk_clk),                                               //       clk.clk
		.reset                 (lcd_0_areset_sink_reset_bridge_in_reset_reset),               // clk_reset.reset
		.av_address            (lcd_0_am_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (lcd_0_am_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (lcd_0_am_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (lcd_0_am_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (lcd_0_am_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (lcd_0_am_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (lcd_0_am_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (lcd_0_am_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (lcd_0_am_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (lcd_0_am_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (lcd_0_am_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (lcd_0_am_agent_cp_valid),                                     //        cp.valid
		.cp_data               (lcd_0_am_agent_cp_data),                                      //          .data
		.cp_startofpacket      (lcd_0_am_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (lcd_0_am_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (lcd_0_am_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (lcd_0_areset_sink_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (lcd_0_as_agent_m0_address),                     //              m0.address
		.m0_burstcount           (lcd_0_as_agent_m0_burstcount),                  //                .burstcount
		.m0_byteenable           (lcd_0_as_agent_m0_byteenable),                  //                .byteenable
		.m0_debugaccess          (lcd_0_as_agent_m0_debugaccess),                 //                .debugaccess
		.m0_lock                 (lcd_0_as_agent_m0_lock),                        //                .lock
		.m0_readdata             (lcd_0_as_agent_m0_readdata),                    //                .readdata
		.m0_readdatavalid        (lcd_0_as_agent_m0_readdatavalid),               //                .readdatavalid
		.m0_read                 (lcd_0_as_agent_m0_read),                        //                .read
		.m0_waitrequest          (lcd_0_as_agent_m0_waitrequest),                 //                .waitrequest
		.m0_writedata            (lcd_0_as_agent_m0_writedata),                   //                .writedata
		.m0_write                (lcd_0_as_agent_m0_write),                       //                .write
		.rp_endofpacket          (lcd_0_as_agent_rp_endofpacket),                 //              rp.endofpacket
		.rp_ready                (lcd_0_as_agent_rp_ready),                       //                .ready
		.rp_valid                (lcd_0_as_agent_rp_valid),                       //                .valid
		.rp_data                 (lcd_0_as_agent_rp_data),                        //                .data
		.rp_startofpacket        (lcd_0_as_agent_rp_startofpacket),               //                .startofpacket
		.cp_ready                (lcd_0_as_burst_adapter_source0_ready),          //              cp.ready
		.cp_valid                (lcd_0_as_burst_adapter_source0_valid),          //                .valid
		.cp_data                 (lcd_0_as_burst_adapter_source0_data),           //                .data
		.cp_startofpacket        (lcd_0_as_burst_adapter_source0_startofpacket),  //                .startofpacket
		.cp_endofpacket          (lcd_0_as_burst_adapter_source0_endofpacket),    //                .endofpacket
		.cp_channel              (lcd_0_as_burst_adapter_source0_channel),        //                .channel
		.rf_sink_ready           (lcd_0_as_agent_rsp_fifo_out_ready),             //         rf_sink.ready
		.rf_sink_valid           (lcd_0_as_agent_rsp_fifo_out_valid),             //                .valid
		.rf_sink_startofpacket   (lcd_0_as_agent_rsp_fifo_out_startofpacket),     //                .startofpacket
		.rf_sink_endofpacket     (lcd_0_as_agent_rsp_fifo_out_endofpacket),       //                .endofpacket
		.rf_sink_data            (lcd_0_as_agent_rsp_fifo_out_data),              //                .data
		.rf_source_ready         (lcd_0_as_agent_rf_source_ready),                //       rf_source.ready
		.rf_source_valid         (lcd_0_as_agent_rf_source_valid),                //                .valid
		.rf_source_startofpacket (lcd_0_as_agent_rf_source_startofpacket),        //                .startofpacket
		.rf_source_endofpacket   (lcd_0_as_agent_rf_source_endofpacket),          //                .endofpacket
		.rf_source_data          (lcd_0_as_agent_rf_source_data),                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),             //                .error
		.rdata_fifo_src_ready    (lcd_0_as_agent_rdata_fifo_src_ready),           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lcd_0_as_agent_rdata_fifo_src_valid),           //                .valid
		.rdata_fifo_src_data     (lcd_0_as_agent_rdata_fifo_src_data),            //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lcd_0_as_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (lcd_0_areset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (lcd_0_as_agent_rf_source_data),                 //        in.data
		.in_valid          (lcd_0_as_agent_rf_source_valid),                //          .valid
		.in_ready          (lcd_0_as_agent_rf_source_ready),                //          .ready
		.in_startofpacket  (lcd_0_as_agent_rf_source_startofpacket),        //          .startofpacket
		.in_endofpacket    (lcd_0_as_agent_rf_source_endofpacket),          //          .endofpacket
		.out_data          (lcd_0_as_agent_rsp_fifo_out_data),              //       out.data
		.out_valid         (lcd_0_as_agent_rsp_fifo_out_valid),             //          .valid
		.out_ready         (lcd_0_as_agent_rsp_fifo_out_ready),             //          .ready
		.out_startofpacket (lcd_0_as_agent_rsp_fifo_out_startofpacket),     //          .startofpacket
		.out_endofpacket   (lcd_0_as_agent_rsp_fifo_out_endofpacket),       //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	soc_system_mm_interconnect_0_router router (
		.sink_ready         (lcd_0_am_agent_cp_ready),                       //      sink.ready
		.sink_valid         (lcd_0_am_agent_cp_valid),                       //          .valid
		.sink_data          (lcd_0_am_agent_cp_data),                        //          .data
		.sink_startofpacket (lcd_0_am_agent_cp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (lcd_0_am_agent_cp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (lcd_0_areset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_router_004 router_004 (
		.sink_ready         (lcd_0_as_agent_rp_ready),                       //      sink.ready
		.sink_valid         (lcd_0_as_agent_rp_valid),                       //          .valid
		.sink_data          (lcd_0_as_agent_rp_data),                        //          .data
		.sink_startofpacket (lcd_0_as_agent_rp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (lcd_0_as_agent_rp_endofpacket),                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (lcd_0_areset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
	...
	) lcd_0_as_burst_adapter (
		.clk                   (clk_0_clk_clk),                                 //       cr0.clk
		.reset                 (lcd_0_areset_sink_reset_bridge_in_reset_reset), // cr0_reset.reset
		...
		.source0_valid         (lcd_0_as_burst_adapter_source0_valid),          //   source0.valid
		.source0_data          (lcd_0_as_burst_adapter_source0_data),           //          .data
		.source0_channel       (lcd_0_as_burst_adapter_source0_channel),        //          .channel
		.source0_startofpacket (lcd_0_as_burst_adapter_source0_startofpacket),  //          .startofpacket
		.source0_endofpacket   (lcd_0_as_burst_adapter_source0_endofpacket),    //          .endofpacket
		.source0_ready         (lcd_0_as_burst_adapter_source0_ready)           //          .ready
	);
	...
	soc_system_mm_interconnect_0_cmd_mux cmd_mux (
		...
		.sink0_ready         (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_valid),         //          .valid
		.sink0_channel       (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_data          (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_startofpacket (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
	...
	soc_system_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		...
		.sink0_ready         (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_valid),         //          .valid
		.sink0_channel       (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_channel),       //          .channel
		.sink0_data          (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_data),          //          .data
		.sink0_startofpacket (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	soc_system_mm_interconnect_0_cmd_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_cmd_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_rsp_mux rsp_mux (
		...
		.sink0_ready         (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_ready),         //     sink0.ready
		.sink0_valid         (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_valid),         //          .valid
		.sink0_channel       (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_channel),       //          .channel
		.sink0_data          (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_data),          //          .data
		.sink0_startofpacket (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket   (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_endofpacket)    //          .endofpacket
	);
	...
	soc_system_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		...
		.sink1_ready         (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_ready),         //     sink1.ready
		.sink1_valid         (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_valid),         //          .valid
		.sink1_channel       (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_channel),       //          .channel
		.sink1_data          (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_data),          //          .data
		.sink1_startofpacket (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink1_endofpacket   (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_endofpacket),   //          .endofpacket
	...
	altera_merlin_width_adapter #(
	...
	) lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                                          //       clk.clk
		.reset                (lcd_0_areset_sink_reset_bridge_in_reset_reset),                                          // clk_reset.reset
		...
		.out_endofpacket      (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (lcd_0_am_to_address_span_extender_0_windowed_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                                            //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                           // clk_reset.reset
		...
		.out_endofpacket      (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_data),          //          .data
		.out_channel          (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (nios2_gen2_0_data_master_to_lcd_0_as_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                    // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                                          //       clk.clk
		.reset                (nios2_gen2_0_reset_reset_bridge_in_reset_reset),                                         // clk_reset.reset
		...
		.out_endofpacket      (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_data),          //          .data
		.out_channel          (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (address_span_extender_0_windowed_slave_to_lcd_0_am_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                                  // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (0)
	) lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                                            //       clk.clk
		.reset                (lcd_0_areset_sink_reset_bridge_in_reset_reset),                            // clk_reset.reset
		...
		.out_endofpacket      (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_data),          //          .data
		.out_channel          (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (lcd_0_as_to_nios2_gen2_0_data_master_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                                    // (terminated)
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (lcd_0_areset_sink_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (lcd_0_as_agent_rdata_fifo_src_data),            //     in_0.data
		.in_0_valid     (lcd_0_as_agent_rdata_fifo_src_valid),           //         .valid
		.in_0_ready     (lcd_0_as_agent_rdata_fifo_src_ready),           //         .ready
