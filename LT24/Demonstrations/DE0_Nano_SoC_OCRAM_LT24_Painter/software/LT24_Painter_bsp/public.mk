...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../DE0_Nano_SoC_golden_top.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x101090
SOPC_SYSID_FLAG += --sidp=0x101090
ELF_PATCH_FLAG  += --sidp 0x101090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1432609607
SOPC_SYSID_FLAG += --timestamp=1432609607
ELF_PATCH_FLAG  += --timestamp 1432609607
